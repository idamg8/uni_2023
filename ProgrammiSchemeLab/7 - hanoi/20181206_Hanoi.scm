...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 20181206_Hanoi) (read-case-sensitive #t) (teachpacks ((lib "20181025_Drawings.ss" "installed-teachpacks") (lib "20181206_Hanoi.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "20181025_Drawings.ss" "installed-teachpacks") (lib "20181206_Hanoi.ss" "installed-teachpacks")) #f)))
...
(define hanoi-disks-rec
  (lambda (n k s d t a b c)
    (cond
      ((= n 0) (list (list s a) (list d b) (list t c)))
      ((< k (expt 2 (- n 1))) (hanoi-disks-rec (- n 1) k s t d (+ a 1) c b))
      (else (hanoi-disks-rec (- n 1) (- k (expt 2 (- n 1))) t d s c (+ b 1) a))
    )
  )
)
